...
{-# LANGUAGE Trustworthy #-}
module Data.Some.Lazy (Some (Some), mkSome, withSome, mapSome, traverseSome) where
...
-- @
--
-- Unlike that conceptual definition, @Some@ can be /unpacked/ into data
-- constructors. The @Some@ pattern synonym simulates this definition.
--
-- === Example
--
...
-- Some TagBool
--
data Some tag = UnsafeSome (tag Any)
